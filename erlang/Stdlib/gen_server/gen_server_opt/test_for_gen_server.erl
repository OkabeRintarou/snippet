...
%% APIS
-export([test1/1, test2/1, test3/1, test4/1, test5/1, test6/1, test7/1, test8/1, test9/1]).
...
handle_info(stop, [Timestamp, Times]) ->
	{A, B, C} = os:timestamp(),
	EndTimestamp = (A * 1000000 + B) * 1000000 + C,
	Cost = EndTimestamp - Timestamp,
	io:format("======gen_server: Times:~p Cost:~p ms~n", [Times, Cost / 1000]),
	{stop, normal, []};
